    ...
    try{
        ...
        if(finalList.length !== 0){
            ...
            const eeveeComment= {
                ...
                "espeon": "포켓몬 슬립 내에서 최고의 스킬 중 하나로 평가 받는 '에너지 차지 M' 스킬을 보유한 포켓몬입니다. 스킬 레벨에 따른 에너지 증가량이 기하급수적으로 늘어나는 것이 특징입니다. 메인 스킬 6렙 기준 잠만보에게 4546의 에너지를 주며, 이는 적당한 요리 1개 분량의 에너지입니다. 에브이의 레벨에 따라 에너지량은 더 증가하므로 실질적인 에너지량은 더 많습니다.",
